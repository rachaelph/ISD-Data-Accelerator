...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Resolve datastore config values with branch overrides applied."
    )
...
def main() -> int:
    ...
    payload = {
        ...
        "hasOverrides": context["HasOverrides"],
        "overrideSourcePath": context["OverrideSourcePath"],
