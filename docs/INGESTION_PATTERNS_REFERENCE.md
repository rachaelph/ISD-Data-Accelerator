...
| Delta-to-Delta or internal table read | Source is an existing Databricks table | [CUSTOM_FUNCTION_SELECTION.md](CUSTOM_FUNCTION_SELECTION.md) when custom logic is needed |
...
| Custom table ingestion function | Internal Databricks table read needs custom logic | [CUSTOM_FUNCTION_SELECTION.md](CUSTOM_FUNCTION_SELECTION.md) |
